...
- Always clear hydrated stores inside the server-side rendering
worker.  This fixes state leak on pages which do not contain
`redux_store` call but use prerendered components.
